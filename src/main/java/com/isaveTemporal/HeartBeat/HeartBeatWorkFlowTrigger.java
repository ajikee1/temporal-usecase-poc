...
Use case:
    ...
    Demonstrates how heartbeats 'last heartbeats details' can be used to handle activity failures on re-try.
    ...
    2. When i = 3, the code throws an exception, demonstrating an activity failure.
    ...
    - On retry, the value of 'Activity.getExecutionContext().getHeartbeatDetails()' (3 in this case) is used to set the loop start to '4'
      and continue with 'i' 4 to 10.
    - Thereby, using heartbeat to skip the failure point on re-try.
